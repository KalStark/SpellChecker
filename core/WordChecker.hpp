...
public:
    ...
    std::string SwapChar(std::string word, int tracker) const;
    std::string InsertChar(std::string word, char letter, int i) const;
    std::string EraseChar(std::string word, int i) const;
    std::string ReplaceChar(std::string word, char letter, int i) const;
    std::string InsertSpace(std::string word, int i) const;
